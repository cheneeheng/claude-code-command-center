#!/usr/bin/env bash
# install.sh - daily-lessons scheduler
#
...
echo ""
echo "=== Daily Lessons Scheduler - Install ==="
...
SCHEDULE_TIME="03:00"
$WANT_CRON && SCHEDULE_TIME=$(prompt_input "  Run time (HH:MM, 24h)" "03:00")
...
cfg=$(echo "$cfg" | jq \
    ...
    '.dailyLessons = {scheduleTime: $time, minUserTurns: $turns, minTranscriptChars: $chars}')
