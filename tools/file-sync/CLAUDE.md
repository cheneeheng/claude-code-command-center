...
- **Tasks live under a `\file-sync\` Task Scheduler folder with per-pair names** so multiple syncs
  coexist. Uninstall takes the same two folders used to install — preserve that symmetry.
