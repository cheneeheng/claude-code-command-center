---
name: claude-code-scheduler-daily-lessons
...
- Windows (PowerShell tool):
  `& "$env:CLAUDE_META_DIR\.claude\scripts\daily-lessons-prepare.ps1"`
- macOS / Linux (Bash tool):
  `bash "$CLAUDE_META_DIR/.claude/scripts/daily-lessons-prepare.sh"`
...
- Windows: `& "$env:CLAUDE_META_DIR\.claude\scripts\git-sync.ps1" -Label "daily-lessons"`
- macOS / Linux: `bash "$CLAUDE_META_DIR/.claude/scripts/git-sync.sh" "daily-lessons"`
